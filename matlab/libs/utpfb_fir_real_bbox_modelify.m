...
%creates bbox model of pfb_fir_real for passing to model_erect etc
function[model, result] = utpfb_fir_real_bbox_modelify(varargin)
model = {}; result = -1;
log_group = 'utpfb_fir_real_bbox_modelify_debug';

utlog('entering utpfb_fir_real_bbox_modelify',{'trace', log_group});
...
[bbox, result] = utpfb_fir_real_bboxify(block{:});
if result ~= 0,
...
utlog('exiting utpfb_fir_real_bbox_modelify',{'trace', log_group});
